...
-- 		tags = tags_list,
-- 	}
-- 	local yaml_str = lyaml.dump(my_tags)
-- 	local filename = directory .. "/.my_tags.yaml"
-- 	write_to_file(filename, yaml_str)
-- 	vim.notify("Tags saved to " .. filename, vim.log.levels.INFO)
-- end
--
...
-- 	end
--
-- 	local config_path = directory .. "/.my_tags.yaml"
-- 	local config = read_yaml_file(config_path)
-- 	if config then
-- 		local last_mod_time = config.last_mod
-- 		local last_modified = get_last_modified(directory)
-- 		if last_modified and last_modified > last_mod_time then
